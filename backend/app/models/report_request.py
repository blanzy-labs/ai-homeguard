...
from app.models.network_discovery import NetworkDiscoveryRequest
...
class CombinedReportRequest(BaseModel):
    ...
    include_network_discovery: bool = False
    ...
    network_discovery_request: NetworkDiscoveryRequest | None = None
